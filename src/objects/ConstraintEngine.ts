...
export class ConstraintEngine {
  ...
  renderConstraints(
    ...
    TPAssert(
      this.initialized,
      "ConstraintEngine needs to be initialized before usage."
    );
    ...
    gl.uniformMatrix4fv(this.shader.getUniformLocation("u_view"), false, view);
    gl.uniformMatrix4fv(this.projMatrixLocation, false, this.projMatrix);
    gl.uniform2f(this.shader.getUniformLocation("u_textureSize"), this.width, this.height);
